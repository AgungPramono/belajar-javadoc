...
1. Tulis source code
2. Tulis javadoc
3. Tambahkan plugin jika menggunakan maven link disini [maven javadoc plugin]
...
6. link plugin maven [maven javadoc plugin]: https://search.maven.org/artifact/org.apache.maven.plugins/maven-javadoc-plugin/3.1.1/maven-plugin
